...
public class InjectPrimaryBeans {
    ...
    // for Bean1-type parameter that has the matching name 'mybean11' autowiring by name should be performed, though this bean has @Fallback annotation
    // for Bean2-type parameter that has the matching name 'mybean20' autowiring by name should be performed, though this bean doesn't have @Primary annotation
    // for Bean3-type parameter that has the matching name 'mybean33' autowiring by name should be performed, though this bean has #defaultCandidate = false
    public InjectPrimaryBeans(Bean1 mybean1, Bean2 mybean2, Bean3 mybean3, Bean3 mybean33, Bean1 mybean11, Bean2 mybean20) {
        // primary/defaults:
        ...
        // by name:
        this.mybean11 = mybean11; // ok
        this.mybean20 = mybean20; // no error, but navigates to default (mybean21) bean that is @Primary-annotated
